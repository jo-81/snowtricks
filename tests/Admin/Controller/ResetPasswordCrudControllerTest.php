...
use App\Controller\Admin\ResetPasswordCrudController;
use App\Entity\User;
...
class ResetPasswordCrudControllerTest extends AbstractCrudTestCase
{
    use UserLoginTrait;
    ...
    {
        return ResetPasswordCrudController::class;
    }
